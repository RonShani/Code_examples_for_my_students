# -*- coding: utf-8 -*-
"""
ספרייה שעושה עבורנו את כל העבודה המסובכת של התעסקות עם אובייקטים תלת-מימדיים: kivy3

מתקינים אותה באמצעות הפקודה:
pip install https://github.com/KeyWeeUsr/kivy3/zipball/master

יש לה טיוטוריאל מאד פשוט ומקיף:
סרטוני הסבר: https://youtube.com/playlist?list=PLP19bggXJC494N7o6DUDJJQ1djJi-k3V-

דוגמאות קוד:
https://github.com/KeyWeeUsr/3DwithKivy

דוגמה פשוטה שהכנתי עבורכם:
https://drive.google.com/drive/folders/1jCKzzwaNI9IEr__kW5Y_ExUtJ-eiK0at?usp=sharing
